    ...
    <div class="insectsearch">
        <div class="head">
            ...
            <div>
                ...
                <label for="checkbox">只显示本月可获得昆虫</label>
        ...
        currentMonthFilter: function() {
            ...
            if (this.checkCurMonth) {
                if (this.picked === "North") {
                    for (let i = 0; i < insectList.length; i++) {
                        for (
                            let j = 0;
                            j < insectList[i].appearNorth.length;
                            j++
                        ) {
                            if (insectList[i].appearNorth[j] === month) {
                    ...
                    for (let i = 0; i < insectList.length; i++) {
                        for (
                            let j = 0;
                            j < insectList[i].appearSouth.length;
                            j++
                        ) {
                            if (insectList[i].appearSouth[j] === month) {
                                tempList[index] = insectList[i];
                                index++;
                                continue;
                            }
